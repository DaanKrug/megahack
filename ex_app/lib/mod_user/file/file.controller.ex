defmodule ExApp.FileController do
  
  import Plug.Conn
  use Plug.Router
  use ExApp.BasicController
  alias ExApp.NumberUtil
  alias ExApp.FileHandler, as: Handler
  alias ExApp.FileService, as: Service
  ...
  post "/fileS3Upload" do
    sendResponse(conn,fileS3Upload(conn,Handler,AuthHandler))
  end
