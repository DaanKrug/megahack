defmodule ExApp.DateUtil do
  ...
  def minusMinutesSql(minutes) do
    ...
    time2 = cond do
      (nowMinutes < minutes) -> Time.new(23 - restHours,60 - (restMinutes - time.minute),0) 
                                  |> StructUtil.getValueFromTuple()
  ...
  def sqlDateToDateTime(sqlDate) do
