...
@Component({
  selector: 'rich-menu-button',
  templateUrl: './richmenubutton.component.html'
})
export class RichMenuButtonComponent extends RichBaseComponent implements OnInit, OnDestroy{
