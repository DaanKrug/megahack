...
export class FormToolbarComponent extends BaseCustomComponent implements OnInit, OnDestroy{
  ...
  ngOnInit(){
	  this.fitMode = window.innerWidth < 300;
  }
